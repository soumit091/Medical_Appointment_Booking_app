...
class DentalDoctorsDetailsScreen extends StatelessWidget {
  const DentalDoctorsDetailsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GetX<DentalDoctorsController>(
          init: DentalDoctorsController(),
          builder: (controller) {
...
class DentalDoctorsController extends GetxController {
  ...
  void fetchDoctors() async {
    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          .collection('doctors')
          .where('docCategory', isEqualTo: 'Dental')
          .get();
